...
public class DataGenerator {
    ...
    public static ExperimentResult runExperiment(
        ...
        return new ExperimentResult(
                        ...
                        model.getAvgIssueFixingTime(),
                        model.getAvgIssueAssessmentTime(),
                        model.getAvgPlanningTime(),
                        model.getTotalImplementationTime(),
                        model.getTotalReviewTime(),
                        model.getTotalRemarkFixingTime(),
                        model.getTotalIssueFixingTime(),
                        model.getTotalIssueAssessmentTime(),
                        model.getTotalPlanningTime(),
                        model.getAvgReviewRoundCount(),
                        model.getAvgTimePostToPre(),
                        model.getAvgTimePreToCust(),
                        model.getAvgIssuesInjectedPerReviewRemark(),
                        model.getAvgIssuesInjectedPerIssueTask(),
                        model.getAvgIssuesInjectedPerImplementationTask(),
                        expDuration,
                        exp.hasError());
